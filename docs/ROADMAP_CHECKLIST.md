...
| `bevy_pbr` (overall) | `mgstudio-engine/pbr` | 95% | 81% | 81% | 🟡 In Progress | Remaining parity gaps concentrate in light/fog/meshlet/deferred depth behavior. |
| `bevy_pbr::render` | `mgstudio-engine/pbr/render` | 96% | 83% | 83% | 🟡 In Progress | Core stage split is landed; remaining gaps are meshlet/advanced pass feature depth. |
...
| Current weighted migration completion (included scope) | 79% |
