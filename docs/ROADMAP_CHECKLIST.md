...
- [ ] Issue `render/bevy_stage_boundary_parity`: `Extract/Prepare/Queue/Execute` entrypoints moved to `render3d_systems` and camera-collection path moved to `render3d_execute_collect`; pending继续拆分 `render3d_execute_impl` remaining monolith.
