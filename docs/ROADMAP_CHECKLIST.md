...
|---|---|---:|---:|---:|---|---|
| `bevy_app` | `mgstudio-engine/app` | 96% | 89% | 89% | 🟡 In Progress | System scheduling and ergonomics still diverge in several APIs. |
