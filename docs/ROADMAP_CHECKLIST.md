...
| `bevy_asset` | `mgstudio-engine/asset` | 91% | 81% | 81% | 🟡 In Progress | Native asset runtime is stable with capability-gated HTTP fetch and image format/texture-format/array-layout/load-meshes meta wiring; deeper parity tails remain. |
