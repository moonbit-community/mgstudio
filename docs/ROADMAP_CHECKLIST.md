...
| `bevy_asset` | `mgstudio-engine/asset` | 92% | 82% | 82% | 🟡 In Progress | Native asset runtime is stable with capability-gated HTTP fetch, expanded Bevy-shaped image extension routing, and image meta settings wiring; deeper parity tails remain. |
