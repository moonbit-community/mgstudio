...
| `mesh` | 79% | 72% | 72% | 🟡 In Progress | Primitive, attribute, vertex-layout, allocator-state, upload-descriptor surfaces, render-mesh allocation planning, renderer mesh3d slab upload execution, and PBR preprocess offset consumption are closer to Bevy. Remaining runtime work is full extracted-asset prepare integration and broader indirect/preprocess draw parity. |
