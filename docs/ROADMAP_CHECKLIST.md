...
| `mesh` | 78% | 70% | 70% | 🟡 In Progress | Primitive, attribute, vertex-layout, allocator-state, upload-descriptor surfaces, render-mesh allocation planning, and renderer mesh3d slab upload execution are closer to Bevy. Remaining runtime work is full extracted-asset prepare integration and indirect/preprocess draw parity. |
