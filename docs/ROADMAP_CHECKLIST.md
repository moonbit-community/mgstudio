...
| `bevy_asset` | `mgstudio-engine/asset` | 90% | 79% | 79% | 🟡 In Progress | Native asset runtime is stable with capability-gated HTTP fetch and image format/texture-format settings wired; deeper parity tails remain. |
