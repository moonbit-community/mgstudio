...
- [ ] Issue `render/bevy_file_mapping_matrix_lock`: matrix synchronized to current split; unresolved render files are `mesh_bindings/mesh_view_bindings/morph`.
...
- [ ] Issue `pbr/bevy_render_file_decomposition`: `skin/light/fog/gpu_preprocess` split landed; pending `mesh_bindings/mesh_view_bindings/morph`.
