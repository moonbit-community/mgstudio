...
- Source-shape scaffold status:
  ...
  - `scaffold_files_with_explicit_bevy_source=806/806` (`scripts/check_bevy_rs_to_mbt_paths.sh`, `scaffold_without_bevy_source=0`)
  - `_scaffold_owner marker files=403` (`rg -l "_scaffold_owner" mgstudio-engine | wc -l`)
