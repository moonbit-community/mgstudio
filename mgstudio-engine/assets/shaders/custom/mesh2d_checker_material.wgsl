...
fn checker_value(uv: vec2<f32>) -> f32 {
    let cell_x = i32(floor(uv.x * 8.0));
    let cell_y = i32(floor(uv.y * 8.0));
...
fn alpha_discard(material: CheckerMaterial, output_color: vec4<f32>) -> vec4<f32> {
