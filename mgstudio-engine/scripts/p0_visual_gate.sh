...
BASELINE_DIR="${MGSTUDIO_PARITY_BASELINE_DIR:-${REPO_DIR}/docs/parity/baselines/bevy_p0_blockers}"
ARTIFACT_ROOT_DEFAULT="${REPO_DIR}/docs/parity/artifacts/p0_visual_gate/$(date +%Y%m%d_%H%M%S)"
